...
layui.use(["element", "layer", "okUtils", "okTab", "okLayer", "okContextMenu"], function () {
  ...
  function getContent() {
    ...
    let content = "";
    if (dateStr == "2019-12-30" || dateStr == "2019-12-31" || dateStr == "2020-01-01") {
      ...
      content = "清明时节雨纷纷，路上行人欲断魂。<br/>" +
        "借问酒家何处有，牧童遥指杏花村。<br/>" +
        "校园二手淘 祝您清明节快乐！(^し^)";
    } else if (dateStr == "2020-05-01" || dateStr == "2020-05-02" || dateStr == "2020-05-03" || dateStr == "2019-05-04") {
      content = "锄禾日当午，汗滴禾下土。<br/>" +
        "谁知盘中餐，粒粒皆辛苦。<br/>" +
        "校园二手淘 祝您劳动节快乐！(^し^)";
    } else if (dateStr == "2020-06-07" || dateStr == "2019-20-08" || dateStr == "2020-06-09") {
      content = "少年佳节倍多情，老去谁知感慨生。<br>" +
        "不效艾符趋习俗，但祈蒲酒话升平。<br>" +
        "鬓丝日日添白头，榴锦年年照眼明。<br>" +
        "千载贤愚同瞬息，几人湮没几垂名。<br>" +
        "校园二手淘 祝您端午节安康！(^し^)";
    } else if (dateStr == "2020-09-13" || dateStr == "2020-09-14" || dateStr == "2020-09-15") {
      ...
      content = "龙跃甲子，鸽翱晴空，凤舞九天。<br/>" +
        ...
        "泰山脊，领风骚环宇，有谁堪比？<br/>" +
        "校园二手淘 祝您国庆节快乐！<br/>祝福伟大的祖国，越来越强大。<br/>祝福强大的祖国，一直屹立于世界东方！(^し^)";
    } else {
      content = "欢迎来到校园二手淘~";
    }
    return content;
