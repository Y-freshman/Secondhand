...
<link rel="stylesheet" href="/home/css/myqiugou.css">
</head>
<body>
		  ...
		  <el-main style="background: linear-gradient(to bottom, #fff , #eee);">
			  ...
			  <el-col :span="17" :offset="1">
			  	<el-tabs type="border-card">
			  	  <el-tab-pane >
				    <span slot="label" @click="typeChange(1)">热度优先<i class="el-icon-download"></i> </span>
				  </el-tab-pane>
				  <el-tab-pane >
				    <span slot="label" @click="typeChange(0)">创建时间<i class="el-icon-download"></i> </span>
				  </el-tab-pane>	  
				</el-tabs>
			  </el-col>
			  <el-col :span="6" >
			  ...
			  <el-col :span="8" >
			  	...
			  	<div style="float: left;min-height: 60px;width:100%"  class="qg_card">
			  		<div style="float: left;width:60px">
				  		...
				  		<el-button @click="liuyan(item.needId)"  type="primary" style="padding: 8px 10px;margin: 5px 0px 0px -13px;" round><i class="el-icon-delete"></i>删除求购</el-button>
			  		</div>
...
<script src="/home/js/myqiugou.js"></script>
